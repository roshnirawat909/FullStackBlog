...
const AIAssistant = ({ onContentGenerated }) => {
  ...
  const [type, setType] = useState('body'); // 'title' or 'body'
  ...
  return (
    <div className="bg-gray-900 p-4 rounded-lg border border-gray-700 mb-6 text-white">
      ...
      <div className="flex flex-col md:flex-row gap-3 mb-4">
        ...
        <Button type="button" onClick={handleGenerate} disabled={loading || !prompt}>
      ...
      {generatedText && (
        <div className="bg-gray-800 p-4 rounded border border-gray-700">
          <h4 className="text-sm font-semibold text-gray-400 mb-2">Generated Result:</h4>
          <div className="whitespace-pre-wrap mb-4 text-gray-200">
            {generatedText}
          </div>
          <div className="flex justify-end">
            <Button 
              type="button"
              onClick={() => onContentGenerated && onContentGenerated(generatedText, type)}
      ...
      {generatedText && (
        <div className="bg-gray-800 p-4 rounded border border-gray-700">
          ...
          <div className="flex justify-end">
            <Button
              type="button"
              onClick={() => onContentGenerated?.(generatedText, type)}
              className="bg-green-600 hover:bg-green-700 text-white"
            >
              Use This Content
            </Button>
